public class Map {
    ...
    public Map() {
        room1 = new Room("Room 1", "The room looks quite empty and dark. It has two doors: one leads to the east, another - to the south. ");
        room2 = new Room("Room 2", "It is a nicely decorated room with a big dining table in the middle, full of food. You can go out of the room through a big wooden door in the east" +
                "and through a metal door in the west.");
        room3 = new Room("Room 3", "This room looks like a weapon storage. There are different swords and shields hanging on the walls, and there are also bows and arrows. " +
                "You can leave the room throw a door in the east, and a room in the south.");
        room4 = new Room("Room 4", "Seems like you entered the library. There are lots of books on the book shelfs. But there is one small book which drawns your attention." +
                "Grab it and continue either throw a metal door in the north, or through a passage in the south.");
        room5 = new Room("Room 5", "Right after the door there is a stairs going down to a dungeon. There is blue light in the darkness. Probably it is a portal?");
        room6 = new Room("Room 6", "Looks like you are in trouble. Right after you enter the room you got attacked by a bunch of skeletons," +
        ...
        room7 = new Room("Room 7", "It looks like a hall for big gatherings, as it has a tribune and many " +
        ...
        room8 = new Room("Room 8", "It's hot in here! thanks to a dragon, which sits on a huge chest and exhales fire. " +
        ...
        room9 = new Room("Room 9", "It is a very dark room, you literally cannot see anything. But after you lit up a match it gets possible to notice a door in the northes" +
